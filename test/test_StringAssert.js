...
describe('StringAssert', () => {
  ...
  describe('isNotEmpty()', () => {
    ...
    it('returns a isString assert if given a tab', () => {
      expect(Assert.that('\t').isString().isNotEmpty()).to.be.instanceof(StringAssert);
    });

    it('returns a isString assert if given a newline', () => {
      expect(Assert.that('\t').isString().isNotEmpty()).to.be.instanceof(StringAssert);
    });

    it('returns a isString assert if given a space', () => {
      expect(Assert.that(' ').isString().isNotEmpty()).to.be.instanceof(StringAssert);
    });

    it('returns a isString assert if given a isString', () => {
